...
void platform_window_toggle_fullscreen(void);
void platform_window_toggle_mximized(void);
...
void* platform_thread_create(void* data, unsigned long (*thread_function)(void* data),
