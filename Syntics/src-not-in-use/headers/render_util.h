...
Rect2D quad(Vertex* vertices, u32* rect_count, V3 pos, V2 size, V4 color, f32
tex_index); Rect2D quad_f(Vertex* vertices, u32* rect_count, V3 pos, V2 size, V4
color, f32 tex_index); Rect2D quad_s(Vertex* vertices, u32* rect_count, V3 pos, V2
size, V4 color, f32 tex_index, f32 shadow_offset); Rect2D quad_sl(Vertex* vertices,
u32* rect_count, V3 pos, V2 size, V4 color, f32 tex_index, f32 shadow_offset); Rect2D
quad_sl_gradiant(Vertex* vertices, u32* rect_count, V3 pos, V2 size, V4 color, f32
tex_index, f32 shadow_offset);
...
Rect2D add_border(Vertex* data, u32* num_indices, V4 border_color, V3 top_left, V2
size, f32 thickness, f32 tex_index);

void quad_middle(Vertex* vertices, V3 pos, V2 size, V4 color, f32 tex_index);

void polygon2D_draw_quads(Vertex* data, Polygon2D poly, f32 z, V4 color, f32
line_width, f32 tex_index);

void polygon2D_draw_lines(Vertex* data, u32* idx_data, Polygon2D poly, f32 z, V4
color, f32 tex_index);

void square_rounded_corners(Vertex* data, u32* idx_data, V3 pos, V2 size, V4 color,
                            f32 seperation, u32 corner_vertices_count, f32
text_index);
...
u32 cube_not_center(Vertex* vertices, u32 offset, V3 pos, V3 size, V4 color, f32
tex_index);
