...
void gui_update_begin(Region_Alloc* region, const V2& dimensions, u32 semaphore_idx,
...
static void set_dock_blue(u32 side_hit, const V2& pos, const V2& size,
                          const V2& docked_pos, const V2& docked_size)
{
