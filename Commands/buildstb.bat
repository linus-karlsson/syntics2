...
cl %CommonCompilerFlags% -IC:..\Syntics\headers -IC:..\Syntics\src -IC:..\Syntics\vendor -IC:\VulkanSDK\1.3.236.0\Include -I"C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.34.31933\include" ..\Syntics\src\syntics.c ..\Syntics\vendor\stb\stb_image.c /link /LIBPATH:"C:\VulkanSDK\1.3.236.0\Lib" %CommonLinkerFlags%
